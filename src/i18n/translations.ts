...
const en = {
  ...
  settings_madhab_fixed: 'As published by {method}',
  settings_madhab_fixedDesc: 'One official Asr time is published for this method and is used automatically.',
...
const tr: Translations = {
  ...
  settings_madhab_fixed: '{method} ikindi vakti',
  settings_madhab_fixedDesc: 'Bu yöntemde tek bir resmi ikindi vakti yayımlanır ve otomatik olarak kullanılır.',
...
const ar: Translations = {
  ...
  settings_madhab_fixed: 'وقت العصر حسب {method}',
  settings_madhab_fixedDesc: 'تنشر هذه الجهة وقتًا رسميًا واحدًا للعصر، ويُعتمد تلقائيًا.',
